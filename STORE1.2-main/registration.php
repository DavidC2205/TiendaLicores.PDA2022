...
<body id="container-page-registration">
    ...
    <section id="form-registration">
        <div class="container">
            ...
            Llene el siguiente formulario y empiece a realizar compras en la mejor tienda de licores de la ciudad!.   
           
            </p>
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/img-registration2.png" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
